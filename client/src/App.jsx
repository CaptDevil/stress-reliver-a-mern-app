      ...
      <div>
        <nav className="navbar navbar-light bg-secondary">
          <div className="container-fluid">
            ...
            <button type="button" className="navbar-brand text-light btn btn-lg fst-italic" data-bs-toggle="modal" data-bs-target="#about-us">About us</button>
            <div className="modal fade" id="about-us" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
              <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div className="modal-content">
                  ...
                  <div className="modal-footer">
                    <button type="button" className="btn btn-info" data-bs-dismiss="modal">Okay, I agree</button>
                  </div>
                </div>
              </div>
            </div>
